...
func TestLiteralToString(t *testing.T) {
	tests := []struct {
		...
		{expr.NewPrimitiveLiteral(float32(1.5), false), "fp32(1.5)"},
		{&expr.ProtoLiteral{Value: "foobar", Type: &types.VarCharType{Nullability: types.NullabilityNullable, Length: 7}}, "varchar?<7>(foobar)"},
...
func TestLiteralToValueString(t *testing.T) {
	tests := []struct {
		...
		{expr.NewPrimitiveLiteral(float32(1.5), false), "1.5"},
		{&expr.ProtoLiteral{Value: "foobar", Type: &types.VarCharType{Nullability: types.NullabilityNullable, Length: 7}}, "foobar"},
