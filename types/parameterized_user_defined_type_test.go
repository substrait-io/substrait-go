...
func TestParameterizedUserDefinedType(t *testing.T) {
	...
	for _, td := range []struct {
		...
		{"udt_noparam", []UDTParameter{}, "u!udt_noparam?", "u!udt_noparam", false, nil, &UserDefinedType{Nullability: NullabilityRequired}},
		{"concrete_udt", []UDTParameter{&DataTypeUDTParam{int8Type}}, "u!concrete_udt?<i8?>", "u!concrete_udt<i8?>", false, nil, &UserDefinedType{Nullability: NullabilityRequired, TypeParameters: []TypeParam{&DataTypeParameter{Type: int8Type}}}},
		{"variable_udt", []UDTParameter{&DataTypeUDTParam{decimalType}}, "u!variable_udt?<decimal<P,S>>", "u!variable_udt<decimal<P,S>>", true, []any{&DataTypeUDTParam{decimalType}}, nil},
		{"udt_with_int", []UDTParameter{&IntegerUDTParam{Integer: 10}}, "u!udt_with_int?<10>", "u!udt_with_int<10>", false, nil, &UserDefinedType{Nullability: NullabilityRequired, TypeParameters: []TypeParam{IntegerParameter(10)}}},
		{"udt_with_str", []UDTParameter{&StringUDTParam{StringVal: "test"}}, "u!udt_with_str?<test>", "u!udt_with_str<test>", false, nil, &UserDefinedType{Nullability: NullabilityRequired, TypeParameters: []TypeParam{StringParameter("test")}}},
		{"udt_with_int_and_str", []UDTParameter{&IntegerUDTParam{Integer: 10}, &StringUDTParam{StringVal: "test"}}, "u!udt_with_int_and_str?<10, test>", "u!udt_with_int_and_str<10, test>", false, nil, &UserDefinedType{Nullability: NullabilityRequired, TypeParameters: []TypeParam{IntegerParameter(10), StringParameter("test")}}},
	} {
