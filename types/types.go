...
func (*RecordType) isRootRef() {}
func (t *RecordType) WithNullability(n Nullability) Type {
	out := *t
	out.Nullability = n
	return &out
}

func (t *RecordType) GetType() Type                     { return t }
func (t *RecordType) GetNullability() Nullability       { return t.Nullability }
func (t *RecordType) GetTypeVariationReference() uint32 { return t.TypeVariationRef }

func (t *RecordType) Equals(rhs Type) bool {
	if b, ok := rhs.(*StructType); ok {
		switch {
		case t.Nullability != b.Nullability:
			return false
...
func (t *RecordType) ToProto() *proto.Type {
	children := make([]*proto.Type, len(t.Types))
	for i, c := range t.Types {
		children[i] = TypeToProto(c)
	}
...
func (t *RecordType) ToProtoFuncArg() *proto.FunctionArgument {
	return &proto.FunctionArgument{
		ArgType: &proto.FunctionArgument_Type{Type: t.ToProto()},
	}
}

func (*RecordType) ShortString() string { return "struct" }
...
func (t *RecordType) ParameterString() string {
	sb := strings.Builder{}
	for i, typ := range t.Types {
		if i != 0 {
			sb.WriteString(", ")
...
func (*RecordType) BaseString() string {
	return "struct"
}
