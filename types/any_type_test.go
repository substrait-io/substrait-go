...
func TestAnyType(t *testing.T) {
	...
	for _, td := range []struct {
	...
	}{
		{
			...
			args:               []Type{decP30S9},
			concreteReturnType: &DecimalType{Precision: 30, Scale: 9, Nullability: NullabilityNullable},
		...
		},
		{
			...
			concreteReturnType: &VarCharType{Length: 37, Nullability: NullabilityNullable},
			nullability:        NullabilityNullable,
			expectedString:     "any1?",
		},
		{
