...
func TestSetComparisonSubqueryValidConstruction(t *testing.T) {
	...
	assert.Equal(t, plan.SetComparisonComparisonOpEq, anyEqSubquery.ComparisonOp)
	...
	assert.Equal(t, plan.SetComparisonComparisonOpNe, allNeSubquery.ComparisonOp)

	// Test with different comparison operations
	comparisonOps := []plan.SetComparisonComparisonOp{
		plan.SetComparisonComparisonOpEq,
		plan.SetComparisonComparisonOpNe,
		plan.SetComparisonComparisonOpLt,
		plan.SetComparisonComparisonOpLe,
		plan.SetComparisonComparisonOpGt,
		plan.SetComparisonComparisonOpGe,
	}
	...
	unspecifiedSubquery := plan.NewSetComparisonSubquery(
		...
		plan.SetComparisonComparisonOpUnspecified,
		left,
		mockRel,
	)
	assert.NotNil(t, unspecifiedSubquery)
	assert.Equal(t, plan.SetComparisonReductionOpUnspecified, unspecifiedSubquery.ReductionOp)
	assert.Equal(t, plan.SetComparisonComparisonOpUnspecified, unspecifiedSubquery.ComparisonOp)
...
func TestSubqueryFromProto(t *testing.T) {
	...
	t.Run("SetComparisonSubquery_ANY_EQ", func(t *testing.T) {
		...
		assert.Equal(t, plan.SetComparisonComparisonOpEq, setComparisonSubquery.ComparisonOp)
	...
	t.Run("SetComparisonSubquery_ALL_LT", func(t *testing.T) {
		...
		assert.Equal(t, plan.SetComparisonComparisonOpLt, setComparisonSubquery.ComparisonOp)
	})
